...
class TareasBD extends StatelessWidget {
  static String routeName = "/tareaBD";
  ...
  Widget build(BuildContext context)  {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Tareas Sqlite"),
      ),
      body: Container(
        child: Center(
          child: FutureBuilder<List<bitacora>>( //El widget FutureBuldire permite construir widgets a partir de Futuros<>
              future: bd.getTareas(), // Lista de todos de los registros extraidos de la tabla vuelos en formato map
